...
def signup(payload: SignupRequest, db: Session = Depends(get_db)):
    """
    Creates your single login — the one you use to manage everything. Not
    per-client; each client you work with is added afterward from inside the
    dashboard (see the clients endpoints), not by signing up again.
    """
